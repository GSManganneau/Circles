...
public class BlackCircle implements Circle {
	...
	public Color color = new Color(1,71,101);
	public Color color2 = new Color(101,143,162);
	...
	public void death() {
		// TODO Auto-generated method stub
		this.dead = true;
		GamePanel.chuteLibre=true;
		GamePanel.messages.add(new Messages((int)(this.x),(int)(this.y),"chute Libre",color2));
		for(int i = 0; i<GamePanel.blueCircles.size();i++){
		GamePanel.blueCircles.get(i).chuteLibre=true;
		...
		GamePanel.blueCircles.get(i).chuteLibre();
		}
	}
